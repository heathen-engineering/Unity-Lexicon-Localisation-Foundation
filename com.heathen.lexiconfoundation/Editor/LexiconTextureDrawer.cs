...
{
    [CustomPropertyDrawer(typeof(LexiconTexture))]
    public class LexiconTextureDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var assetProp   = property.FindPropertyRelative("_literalTexture");
            ...
            else
            {
                ...
                var obj = EditorGUI.ObjectField(fieldRect, assetProp.objectReferenceValue, typeof(Texture2D), false);
            ...
            if (GUI.Button(modeRect, modeLabel))
                LexiconAssetMenuHelper.ShowMenu(modeProp, keyProp, LexiconHintType.Texture);
