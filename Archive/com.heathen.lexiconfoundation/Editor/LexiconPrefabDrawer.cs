...
{
    [CustomPropertyDrawer(typeof(LexiconPrefab))]
    public class LexiconPrefabDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var assetProp   = property.FindPropertyRelative("_literalPrefab");
            ...
            else
            {
                ...
                var obj = EditorGUI.ObjectField(fieldRect, assetProp.objectReferenceValue, typeof(GameObject), false);
            ...
            if (GUI.Button(modeRect, modeLabel))
                LexiconAssetMenuHelper.ShowMenu(modeProp, keyProp, LexiconHintType.Prefab);
